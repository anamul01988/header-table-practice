...
const SearchAddPage = () => {
    const handelSubmit = (e) => {
        ...
        console.log(e.target.page_attach.value);
        console.log(e.target.page_number.value);   
    }
    return (
      <div className='mt-5'>
        <form onSubmit={handelSubmit}>
          <Grid container spacing={3}>
            ...
            <Grid item lg={3} xs={6} md={4}>
              <FormLabel className="mt-2 ms-2">Page Attach</FormLabel>
              <TextField
                style={{ margin: "7px" }}
                label={<Box></Box>}
                variant="outlined"
            ...
            <Grid item lg={3} xs={6} md={4}>
              <FormLabel className="mt-2 ms-2">Page Number</FormLabel>
              <TextField
                style={{ margin: "7px" }}
                label={<Box></Box>}
                variant="outlined"
